...
export const BLOQUES = [
  "macro", "ejecutivo", "generales", "emergencia", "vertical",
  "hq", "equipo", "financiamiento", "playa", "color",
];
/* Cuántas cartas tiene cada bloque según docs/deck-lote-2.md (tabla resumen). */
export const CARTAS_POR_BLOQUE = {
  macro: 15, ejecutivo: 12, generales: 20, emergencia: 5, vertical: 16,
...
export const Card = z
  .object({
    id: z.string().regex(/^(M|EJ|G|E|V|H|T|F|P|C)-\d{2}$/),
    ...
    opciones: z.array(Opcion).min(2).max(3),
