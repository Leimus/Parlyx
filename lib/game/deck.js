...
/* Turno 1 garantizado (PRD v0.3 §8): el origen de toda carrera. */
export const ORIGEN_CARD = {
  id: "OR-01",
  bloque: "generales",
  titulo: "El Origen",
  flavor: "Tenés un laburo estable y una idea que no te deja dormir. Es 1993: nadie sabe qué es internet, y vos tampoco — pero la idea no afloja.",
  tipo: "T3",
  sintetica: true,
  elegibilidad: { modos: ["founder"] },
  opciones: [
    { id: "A", label: "Renunciar y a la pileta", raw: "RW -3m · TEND +2 (sin red, con hambre)", efectos: { rw: -3, tend: 2 } },
    { id: "B", label: "Garage de fin de semana", raw: "TEND +1 recién en 2 trienios · sin riesgo", efectos: { tendLenta: 1 } },
    { id: "C", label: "Freelancear para financiarte", raw: "RW +3m · TEND +1 · dormís poco", efectos: { rw: 3, tend: 1 } },
  ],
};
